  ...
  en: {
    translation: {
      ...
      blog: {
        eyebrow: 'Blog',
        title: 'Notes & writing.',
        lead: 'Thoughts on frontend, design systems and building with AI.',
        all: 'All',
        filterLabel: 'Filter by topic',
        empty: 'No articles for this topic yet.',
  ...
  de: {
    translation: {
      ...
      blog: {
        ...
        lead: 'Gedanken zu Frontend, Design Systems und Entwicklung mit KI.',
        all: 'Alle',
        filterLabel: 'Nach Thema filtern',
        empty: 'Zu diesem Thema gibt es noch keine Beiträge.',
  ...
  es: {
    translation: {
      ...
      blog: {
        ...
        lead: 'Ideas sobre frontend, design systems y desarrollo con IA.',
        all: 'Todos',
        filterLabel: 'Filtrar por tema',
        empty: 'Aún no hay artículos sobre este tema.',
  ...
  fr: {
    translation: {
      ...
      blog: {
        eyebrow: 'Blog',
        title: 'Notes & écrits.',
        lead: 'Réflexions sur le frontend, les design systems et le développement avec l’IA.',
        all: 'Tous',
        filterLabel: 'Filtrer par thème',
        empty: 'Pas encore d’articles sur ce thème.',
