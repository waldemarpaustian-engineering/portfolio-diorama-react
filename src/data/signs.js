...
export const LANTERNS = [
  ...
  // left lantern (next to the insect swarm) — warm flicker with a deeper dim dip
  { p: [0.6612, 0.0758, -0.1548], pulseAmount: 0.16, pulseSpeed: 1.6, pulseFloor: 0.22 },
...
export const SWARMS = [
  { p: [0.7907, 0.0843, -0.1496], count: 9, radius: 0.09, color: '#141008', size: 0.005, speed: 1.3, glow: false, buzz: true, follow: true },
]
...
// `lines` = the text, `symbol` = the little glyph below it. Text comes from i18n via `id`.
export const BOARDS = [
